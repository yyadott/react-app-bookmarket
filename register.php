...
if (isset($_POST['register'])) {
    ...
    // DATA DEFAULT (Diatur kosong untuk nanti dikonfigurasi di halaman Edit Profile)
    $jeniskelamin = "-";
    $nohp   = "-";
    $alamat = "-";
    $role   = "User";

    // LOGIKA VALIDASI BATAS MINIMUM 8 DAN MAKSIMUM 16 KARAKTER
    if (strlen($password_raw) < 8 || strlen($password_raw) > 16) {
        ...
        // Hashing Password jika lolos validasi
