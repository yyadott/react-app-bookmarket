...
<head>
    ...
    <style>
        body, html {
            ...
            background-position-y: 62px; /* Memberikan offset setinggi navbar agar background presisi */
        ...
        /* NAVBAR UTAMA (Menyesuaikan dengan Gambar UI Atas) */
        .navbar-custom {
                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password" class="form-control form-control-custom" 
                                       placeholder="Masukkan password Anda" required>
                                <button class="btn btn-outline-secondary bg-white border" type="button" id="togglePassword" style="border-top-right-radius: 0.375rem; border-bottom-right-radius: 0.375rem;">
