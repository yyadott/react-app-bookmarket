                            ...
                            <div class="row g-0 align-items-center cart-item-row">
                                <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <?php } ?>
                                        <div>
                                            <h6 class="cart-book-title mb-0"><?= $produk['namaproduk'] ?></h6>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="summary-card">
                        ...
                        <?php if ($first_product) { ?>
                            <div class="d-flex align-items-center gap-3 p-3 border rounded-3 mb-4 bg-light bg-opacity-50">
                                ...
                                <?php } ?>
                                <div>
                                    <h6 class="fw-bold text-dark mb-1" style="font-size: 0.9rem; line-height: 1.3;"><?= $first_product['namaproduk'] ?></h6>
    ...
    <?php } else { ?>
        <div class="card border-0 shadow-sm rounded-4 max-width mx-auto" style="max-width: 600px;">
            <div class="card-body text-center py-5">
                ...
                <?php if ($sudah_login) { ?>
                    <a href="produk.php" class="btn btn-checkout-primary px-4 rounded-pill text-decoration-none">Login Untuk Belanja!</a>
                <?php } else { ?>
                    <button type="button" onclick="peringatanLogin()" class="btn btn-need-login-cart px-4 rounded-pill">
                        <i class="bi bi-box-arrow-in-right me-1"></i> Login untuk Belanja!
                    </button>
                <?php } ?>
            </div>
        </div>
...
<script>
    ...
    // Fungsi Interseptor: Mencegah akses dan melempar ke login.php
    function periangatanLogin() {
        alert('Silakan login terlebih dahulu untuk melanjutkan aktivitas belanja di Book Market.');
        window.location.href = "login.php";
    }
    // Alias pembungkus jika typo pemanggilan fungsi di elemen HTML
