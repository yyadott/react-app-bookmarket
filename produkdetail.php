...
<style>
    ...
    /* Style khusus tombol login pengalih */
    .btn-need-login {
...
<script>
    ...
    // Fungsi Interseptor: Mengarahkan user yang belum login ke login.php
    function peringatanLogin() {
        alert('Silakan login terlebih dahulu untuk melanjutkan pembelian buku favorit Anda.');
